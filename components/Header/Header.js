            ...
            <button className="contact-us">
              ...
              <span className="d-block show-mobile" onClick={ () => this.setState({ showMenuMobile: !this.state.showMenuMobile }) }>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 6H22" stroke="white" strokeOpacity="1" stroke-width="1.2" stroke-linecap="round"/>
                  <path d="M2 12H14" stroke="white" strokeOpacity="1" stroke-width="1.2" stroke-linecap="round"/>
                  <path d="M2 18H22" stroke="white" strokeOpacity="1" stroke-width="1.2" stroke-linecap="round"/>
                </svg>
              </span>
            </button>
          </div>
